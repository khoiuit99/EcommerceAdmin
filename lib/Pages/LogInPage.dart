...
import 'package:flutterappadmin/Pages/HomePage.dart';
        ...
        children: <Widget>[
          ...
          Padding(
            ...
            child: Container(
              ...
              child: Image.asset("images/logo_transparent.png", width: 300, height: 300,),
              ),
            ),
          LayoutBuilder(
    ...
    if (formState.validate()) {
      ...
      try{
        ...
        docRef.get().then((documentSnapshot) async {
          ...
          }else if(documentSnapshot["isLoggedIn"] == false && user.isEmailVerified){
